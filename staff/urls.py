...
urlpatterns = [
    ...
    path("staff_logout/",staff_logout,name='staff_logout'),
     path('api/staff/update-profile-picture/',update_profile_picture, name='staff_update_profile_picture'),
    ...
    # MCQ
    path("api/mcq-bulk-upload/", bulk_upload_mcq, name="mcq_bulk_upload"),
